                ...
                child: sourceList.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final price =
                              (item['base_price'] as num?)?.toInt() ?? 0;
                          final diff = (item['difficulty_score'] as num?)
                              ?.toInt();
                          final bool isTBD = item['is_tbd'] == true;
                          final String tbdLabel =
                              item['tbd_label'] ?? 'Harga Menyusul';
      ...
      children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          InkWell(
                            onTap: () =>
                                CartService.instance.updateQty(item, -1, isMCU),
                            child: const Padding(
        ...
        SizedBox(
          ...
          child: OutlinedButton.icon(
            ...
            label: Text(
              selectedList.isEmpty ? 'Pilih $title' : 'Tambah $title',
