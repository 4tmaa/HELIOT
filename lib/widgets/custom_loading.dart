...
class CustomShimmerBox extends StatefulWidget {
  ...
  @override
  State<CustomShimmerBox> createState() => _CustomShimmerBoxState();
}

class _CustomShimmerBoxState extends State<CustomShimmerBox> with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _animation;
