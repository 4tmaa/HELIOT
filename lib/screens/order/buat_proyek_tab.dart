  ...
  Future<void> _submitProject() async {
    ...
    try {
      ...
      await supabaseClient.from('orders').insert({
        ...
        'connectivity': _selectedConnectivity != null ? jsonEncode(_selectedConnectivity) : 'Tidak Ditentukan',
        'enclosure': _selectedEnclosure != null ? jsonEncode(_selectedEnclosure) : 'Tidak Ditentukan',
